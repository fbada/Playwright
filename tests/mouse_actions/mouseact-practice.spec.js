...
test.describe('Context Menu Page Interactions', () => {
    ...
    test.skip('Right-click on the target box triggers correct alert', async ({ page }) => {
    ...
    test.skip('Left-click on the target box does NOT trigger the context menu alert', async ({ page }) => {
